"""
Django settings for broad_snowflake_45001 project.
...
ROOT_URLCONF = 'broad_snowflake_45001.urls'
...
WSGI_APPLICATION = 'broad_snowflake_45001.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broad_snowflake_45001 API",
    "DESCRIPTION": "API documentation for broad_snowflake_45001 App",
    "VERSION": "v1",
}
